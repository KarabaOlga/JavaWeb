...
public class CalculateTest {
	...
	public void positive_PositiveTerms_Test() {
		ResultPage resultPage = calculateCheckResult("2", "3", Constant.RESULT_PAGE);
		// Compare result
	...
	public void positive_ZeroPositiveTerms_Test() {
		ResultPage resultPage = calculateCheckResult("2", "0", Constant.RESULT_PAGE);
		// Compare result
	...
	public void positive_ZeroZeroTerms_Test() {
		ResultPage resultPage = calculateCheckResult("0", "0", Constant.RESULT_PAGE);
		// Compare result
	...
	public void negative_OneLetter_Test() {
		ResultPage resultPage = calculateCheckResult("a", "3", Constant.ERROR_PAGE);
		// Compare result
	...
	public void negative_TwoLetters_Test() {
		ResultPage resultPage = calculateCheckResult("a", "b", Constant.ERROR_PAGE);
		// Compare result
		Assert.assertEquals(MESSAGE_INCORRECT_TERM, resultPage.returnErrorMessage());
	}
	...
	public void negative_OneSymbol_Test() {
		ResultPage resultPage = calculateCheckResult("@", "3", Constant.ERROR_PAGE);
		// Compare result
		Assert.assertEquals(MESSAGE_INCORRECT_TERM, resultPage.returnErrorMessage());
	}
	...
	public void negative_TwoSymbol_Test() {
		ResultPage resultPage = calculateCheckResult("?", "*", Constant.ERROR_PAGE);
		// Compare result
		Assert.assertEquals(MESSAGE_INCORRECT_TERM, resultPage.returnErrorMessage());
	}
